def k_fold_indi_fine(x_train, y_train, x_val, y_val, model_name1, fold_no,  NUM_EPOCHS=10, train_batch=16, validation_batch=16):
    ...
    # Compile the model
    # learning_rate=0.0001 actual
    model1.compile(loss='sparse_categorical_crossentropy',
                   optimizer=tf.keras.optimizers.Adam(
                       learning_rate=0.000001, beta_1=0.9, beta_2=0.999, decay=0.0001),
                   metrics=['accuracy'])
