def without_layer(x_train, y_train, x_val, y_val, model_name1, model_name2, model_name3,  NUM_EPOCHS=70, train_batch=16, validation_batch=16):
    ...
    model1 = create_model1(model_name1)
    ...
    model2 = create_model1(model_name2)
    ...
    model3 = create_model1(model_name3)
